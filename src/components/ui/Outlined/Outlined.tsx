...
//           className={`absolute px-1 transition-all duration-200 ${
//             isFloating
//               ? `-top-3 left-3 text-xs font-semibold bg-white ${disabled ? 'text-gray-400' : 'text-indigo-600'}`
//               : `top-2 left-2 text-sm ${disabled ? 'text-gray-400' : 'text-gray-500'}`
//           }`}
//         >
//           {label}
//         </span>
...
//         onBlur={handleBlur}
//         isDisabled={disabled}
//         className={`w-full border-none ${disabled ? 'bg-gray-50' : 'bg-transparent'}`}
//         styles={{
//           control: (provided) => ({
//             ...provided,
//             minHeight: '36px',
...
//             ...provided,
//             marginTop: isFloating ? '8px' : '0',
//             backgroundColor: disabled ? '#E5E7EB' : provided.backgroundColor,
//           }),
//           input: (provided) => ({
//             ...provided,
//             marginTop: isFloating ? '8px' : '0',
