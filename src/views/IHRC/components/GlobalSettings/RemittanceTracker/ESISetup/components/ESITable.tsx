    ...
    const columns = useMemo(
        () => [
            ...
            },
            {
                ...
                cell: ({ row }) => (
                    <div className="w-40 text-start">
                        {formatDayWithSuffix(row.original.esi_payment_due_date?.first_date)}
                    </div>
                ),
            },
            {
                ...
                cell: ({ row }) => (
                    <div className="w-40 text-start">
                        {formatDayWithSuffix(row.original.esi_payment_due_date?.second_date )}
                    </div>
                ),
            },
            {
                ...
                cell: ({ row }) => (
                    <div className="w-40 text-start">
                        {formatDayWithSuffix(row.original.esi_payment_due_date?.third_date)}
                    </div>
                ),
            },
            {
                ...
                cell: ({ row }) => (
                    <div className="w-40 text-start">
                        {formatDayWithSuffix(row.original.esi_payment_due_date?.last_date
                           )}
                    </div>
                ),
            },
