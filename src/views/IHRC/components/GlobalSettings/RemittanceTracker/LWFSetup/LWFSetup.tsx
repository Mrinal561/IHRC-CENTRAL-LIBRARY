...
import {
    clearCurrentLWFConfig,
    createLWFConfig,
    fetchLWFConfigs,
    updateLWFConfig,
} from '@/store/slices/lwfConfig/lwfConfigSlice'
...
const LWFSetup = () => {
    ...
    const { lwfConfigs, loading, error, currentLWFConfig } = useSelector(
        (state: RootState) => state.lwfconfig,
    )
    ...
    const handleEdit = (config) => {
        ...
        const selectedStateObj = states.find(
            (state) => state.value === config.state_id,
        )
