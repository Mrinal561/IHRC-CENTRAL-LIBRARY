...
const PTSetup: React.FC = () => {
    ...
    const { loading, error, success } = useSelector(
        (state: RootState) => state.ptconfig,
    )
    ...
    const isDueDateDisabled = (prefix: 'ptEc' | 'ptRc', dateIndex: number) => {
        const frequency =
            prefix === 'ptEc' ? ptData.ptEcFrequency : ptData.ptRcFrequency
    ...
    const handleConfirm = async () => {
        ...
        try {
            const ptConfigData: PTConfigData = {
                ...
                ptec_frequency: ptData.ptEcFrequency as
                    | 'monthly'
                    | 'half_yearly'
                    | 'yearly'
                    | 'quarterly',
                ptrc_frequency: ptData.ptRcFrequency as
                    | 'monthly'
                    | 'half_yearly'
                    | 'yearly'
                    | 'quarterly',
                            ...
                            <OutlinedSelect
                                ...
                                value={
                                    frequencyOptions.find(
                                        (option) =>
                                            option.value ===
                                            ptData.ptEcFrequency,
                                    ) || null
                                }
                                onChange={(value) =>
                                    handleInputChange('ptEcFrequency', value)
                                }
                            />
                        </div>
                        <div className="w-1/2">
                            ...
                            <OutlinedSelect
                                ...
                                value={
                                    frequencyOptions.find(
                                        (option) =>
                                            option.value ===
                                            ptData.ptRcFrequency,
                                    ) || null
                                }
                                onChange={(value) =>
                                    handleInputChange('ptRcFrequency', value)
                                }
                            />
                        </div>
                    </div>
