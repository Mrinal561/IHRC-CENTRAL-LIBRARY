...
const Register = () => {
  ...
  const fetchRegisterData = async () => {
    try {
      ...
      const response = await httpClient.get(endpoints.register.list(), { params });
  ...
  const handleDownloadOriginal = async (id: number) => {
    try {
      const response = await httpClient.get(endpoints.register.downloadOriginal(id), {
        responseType: 'blob'
      });
  ...
  const handleDownloadProcessed = async (id: number) => {
    try {
      const response = await httpClient.get(endpoints.register.downloadProcessed(id), {
        responseType: 'blob'
      });
  ...
  const handleExport = async () => {
    try {
      const response = await httpClient.get(endpoints.register.export(), {
        responseType: 'blob'
      });
