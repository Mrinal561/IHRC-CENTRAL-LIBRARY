...
//       second_due_date: Yup.string()
//         .when('due_date_frequency', {
//           is: 'quarterly',
//           then: (schema) => schema.required('Second due date is required for quarterly frequency')
//         }),
//       third_due_date: Yup.string()
//         .when('due_date_frequency', {
//           is: 'quarterly',
//           then: (schema) => schema.required('Third due date is required for quarterly frequency')
//         }),
//       last_due_date: Yup.string()
//         .when('due_date_frequency', {
//           is: (val: string) => ['half_yearly', 'quarterly'].includes(val?.toLowerCase()),
//           then: (schema) => schema.required('Last due date is required for this frequency')
//         })
//     }).test(
//       'unique-dates',
