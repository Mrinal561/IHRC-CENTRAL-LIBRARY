...
const ComplianceEditForm = () => {
        ...
        try {
          ...
          if (response) {
            ...
            setFormData({
              ...
              second_date: response.second_date || null,
              third_date: response.third_date || null,
              last_date: response.default_due_date?.last_date || '',
              scope: response.scope || '',
              state_id: response.state_id || null,
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (id) {
        const result = await dispatch(updateCompliance({ id, data: transformedData }))
        .unwrap()
        .catch((error: any) => {
...
//         disabled={isLoading}
//     >
//         {isLoading ? 'Updating...' : 'Edit Compliance'}
//     </Button>
//     <Button
//         type="button"
//         variant="plain"
